...
public class DateUtil {
     ...
     * @return 时间戳
     */
    public static long startOfSomeDayBefore(int dayUntilNow) {
        Calendar calendar = Calendar.getInstance();
        calendar.set(Calendar.HOUR_OF_DAY, 0);
        calendar.set(Calendar.MINUTE, 0);
        calendar.set(Calendar.SECOND, 0);
     ...
     * @return 时间戳
     */
    public static long startOfSomeDayAfter(int dayUntilNow) {
        Calendar calendar = Calendar.getInstance();
        calendar.set(Calendar.HOUR_OF_DAY, 0);
        calendar.set(Calendar.MINUTE, 0);
        calendar.set(Calendar.SECOND, 0);
     ...
     * @return 时间戳
     */
    public static long endOfSomeDayBefore(int dayUntilNow) {
        Calendar calendar = Calendar.getInstance();
        calendar.set(Calendar.HOUR_OF_DAY, 23);
        calendar.set(Calendar.MINUTE, 59);
        calendar.set(Calendar.SECOND, 59);
     ...
     * @return 时间戳
     */
    public static long endOfSomeDayAfter(int dayUntilNow) {
        Calendar calendar = Calendar.getInstance();
        calendar.set(Calendar.HOUR_OF_DAY, 23);
        calendar.set(Calendar.MINUTE, 59);
        calendar.set(Calendar.SECOND, 59);
    ...
    public static long getDateLineAfterSomeDays(int days){
        Calendar calendar=Calendar.getInstance();
    ...
    public static void main(String[] args) {
        dayReport(DateUtil.toDate("2019-10-11",null));
    }
}
