<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-button class="filter-item" type="primary" icon="el-icon-search" @click="handleFilter">高级节目查找</el-button>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        width: [
          { required: true, message: '节目宽不能为空', trigger: 'blur' }
        ],
        height: [
